...
- [x] 1.0 — Collect current canonical workflow locality and gate evidence
  ...
  - Runtime: `external=agent://ses_REDACTED01; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [x] 1.2 — Implement formal lifecycle orchestration in canonical `aili-workflows`
  ...
  - Runtime: `external=agent://ses_REDACTED02; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [x] 1.3 — Synchronize the accepted workflow snapshot and lock into `aili-pi`
  ...
  - Runtime: `external=agent://ses_REDACTED03; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [x] 2.1 — Implement the formal v1 parser and deterministic validator
  ...
  - Runtime: `external=agent://ses_REDACTED04; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [x] 2.2 — Implement exact formal OpenSpec root resolution and initialization
  ...
  - Runtime: `external=agent://ses_REDACTED05; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [x] 2.3 — Implement transitions, evidence/disposition, joins, and append-only progress
  ...
  - Runtime: `external=agent://ses_REDACTED06; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [x] 2.3a — Implement the exact opt-in external bootstrap reconciliation bridge
  ...
  - Runtime: `external=agent://ses_REDACTED07; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [x] 2.4 — Enforce ROSE-only board writes and restart reconciliation
  ...
  - Runtime: `external=agent://ses_REDACTED08; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [x] 3.1 — Generate the canonical catalog and phase-relevant views
  ...
  - Runtime: `external=agent://ses_REDACTED09; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [x] 3.2 — Add orchestration guidance to task and lifecycle model-facing surfaces
  ...
  - Runtime: `external=agent://ses_REDACTED10; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [x] 3.3 — Implement formal Owner dispatch, waiver, sync/async join, and phase gates
  ...
  - Runtime: `external=agent://ses_REDACTED11; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [x] 4.1 — Implement explicit one-change legacy opt-in
  ...
  - Runtime: `external=agent://ses_REDACTED12; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [x] 4.2 — Produce documentation consistency evidence
  ...
  - Runtime: `external=agent://ses_REDACTED13; transport=external-task-session/v1; unavailable=job,turn,history`
...
- [ ] 4.3 — Apply accepted documentation updates
  ...
  - Blocker: `The approved local canonical-source path did not exist and the user selected Keep packages blocked; canonical attachment/write/synchronization and AGENTS.md source ownership remain unresolved.`
