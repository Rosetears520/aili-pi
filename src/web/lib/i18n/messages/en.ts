...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "session.projectDir": "Project directory",
    "session.gitBranch": "Git branch",
    "session.gitWorktree": "Worktree",
    "session.copyProjectValue": "Copy project value",
    ...
    "viewer.copyContent": "Copy file contents",
    "viewer.copied": "Copied",
    "viewer.goToLine": "#Line",
    "terminal.title": "Terminal · User controlled",
    "terminal.open": "Terminal",
    "terminal.close": "Close terminal",
    "terminal.connecting": "Starting terminal...",
    "terminal.ended": "Terminal session ended.",
    "terminal.unavailable": "Terminal unavailable: {reason}",
    "terminal.status.connecting": "starting",
    "terminal.status.ready": "user controlled",
    "terminal.status.ended": "ended",
    "terminal.status.error": "error",
    "mcp.panelTitle": "MCP",
    "mcp.open": "MCP",
    "mcp.close": "Close MCP panel",
    "mcp.loading": "Loading MCP servers...",
    "mcp.summary": "{enabled} of {total} enabled",
    "mcp.reloadHint": "Changes apply after the session reloads.",
    "mcp.mode": "MCP mode for {name}",
    "mcp.lifecycleEager": "eager",
    "mcp.lifecycleKeepAlive": "keep-alive",
    "mcp.lifecycleLazy": "lazy",
    "mcp.lifecycleLazyKeepAlive": "lazy-keep-alive",
    "mcp.stateEnabled": "enabled",
    "mcp.stateDisabled": "disabled",
    "mcp.actionEnable": "Enable",
    "mcp.actionDisable": "Disable",
    "mcp.enable": "Enable {name}",
    "mcp.disable": "Disable {name}",
    "mcp.empty": "No MCP servers configured for this directory",
    "mcp.rt.connected": "connected",
    "mcp.rt.cached": "cached",
    "mcp.rt.failed": "failed",
    "mcp.rt.needsAuth": "needs auth",
    "mcp.rt.notConnected": "not connected",
    "mcp.rt.disabled": "disabled",
    "mcp.rt.tools": "{count} tools",
    "mcp.rt.summary": "{connected} connected · {tools} tools",
    ...
    "chat.editorEnterHint": "Enter inserts a newline and never sends",
    "chat.editorPreviewEmpty": "Nothing to preview yet",
    ...
    "i18n.thoughtFor": "Thought for {seconds}s",
    "chat.questionnaireSelectAll": "Select every option that applies.",
    "chat.questionnaireRecommended": "Recommended",
    "chat.questionnaireCustom": "Type your own answer",
    "chat.questionnaireCustomPlaceholder": "Your answer",
    "chat.questionnaireCustomHint": "Enter save · Esc back",
    "chat.questionnaireCount": "{count} questions",
    "chat.questionnaireAnsweredSummary": "Questions answered · {answered}/{total}",
    "chat.questionnaireAsking": "Asking user",
    "chat.questionnaireDismissed": "Questionnaire dismissed",
    "chat.questionnaireUnanswered": "Unanswered",
    "chat.questionnaireReview": "Review",
    "chat.questionnaireReviewTitle": "Review answers",
    ...
    "changes.vsUpstream": "vs Upstream",
    "changes.unified": "Unified",
    "changes.split": "Split",
    "changes.diffLayout": "Diff layout",
    "changes.tree": "Tree",
    "changes.flat": "Flat",
    "changes.listLayout": "File list layout",
    "changes.resizeList": "Resize file list",
    "changes.dragResize": "Drag or arrow keys to resize · double-click to reset",
    "changes.oneFile": "1 file",
    "changes.fileCount": "{count} files",
    "changes.refresh": "Refresh",
    "changes.closeTab": "Close tab",
    "changes.branch": "Branch",
    "changes.switchBranch": "Switch branch",
    "changes.switchBranchHint": "Switch branch; a branch held by another worktree jumps to it",
    "changes.project": "Project",
    "changes.pickOtherProject": "Choose another directory…",
    "changes.inWorktree": " (worktree)",
    "changes.detached": "(detached)",
    "changes.noDirectory": "No working directory selected.",
    "changes.chooseDirectory": "Choose a directory…",
    "changes.chooseAnother": "Choose another directory…",
    "changes.notGit": "Not a git repository.",
    "changes.loading": "Loading…",
    "changes.noLocalChanges": "No local changes",
    "changes.noUpstreamDiff": "No differences versus upstream",
    "changes.noUpstream": "No upstream branch configured",
    "changes.selectFile": "Select a file",
    "changes.loadingDiff": "Loading diff…",
    "changes.pickTitle": "Choose repository directory",
    "changes.pickParent": "Parent directory",
    "changes.pickSystem": "System dialog…",
    "changes.pickNoSubdirs": "No subdirectories",
    "changes.pickCancel": "Cancel",
    "changes.pickConfirm": "Choose this directory",
    "changes.pickHome": "Home",
  },
};
