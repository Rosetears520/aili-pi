...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "viewer.copyContent": "复制文件内容",
    "viewer.copied": "已复制",
    "viewer.goToLine": "#行号",
    "terminal.title": "终端 · 用户控制",
    "terminal.open": "终端",
    "terminal.close": "关闭终端",
    "terminal.connecting": "正在启动终端…",
    "terminal.ended": "终端会话已结束。",
    "terminal.unavailable": "终端不可用：{reason}",
    "terminal.status.connecting": "启动中",
    "terminal.status.ready": "用户控制",
    "terminal.status.ended": "已结束",
    "terminal.status.error": "错误",
    "mcp.panelTitle": "MCP",
    "mcp.open": "MCP",
    "mcp.close": "关闭 MCP 面板",
    "mcp.loading": "正在加载 MCP 服务器…",
    "mcp.summary": "已启用 {enabled}/{total}",
    "mcp.reloadHint": "改动将在会话重载后生效。",
    "mcp.mode": "{name} 的 MCP 模式",
    "mcp.lifecycleEager": "eager（启动即连接）",
    "mcp.lifecycleKeepAlive": "keep-alive（保持连接）",
    "mcp.lifecycleLazy": "lazy（按需连接）",
    "mcp.lifecycleLazyKeepAlive": "lazy-keep-alive（按需后保持）",
    "mcp.stateEnabled": "已启用",
    "mcp.stateDisabled": "已停用",
    "mcp.actionEnable": "启用",
    "mcp.actionDisable": "停用",
    "mcp.enable": "启用 {name}",
    "mcp.disable": "停用 {name}",
    "mcp.empty": "此目录下没有配置 MCP 服务器",
    "mcp.rt.connected": "已连接",
    "mcp.rt.cached": "已缓存",
    "mcp.rt.failed": "失败",
    "mcp.rt.needsAuth": "需认证",
    "mcp.rt.notConnected": "未连接",
    "mcp.rt.disabled": "已停用",
    "mcp.rt.tools": "{count} 个工具",
    "mcp.rt.summary": "{connected} 已连接 · {tools} 个工具",
    ...
    "chat.editorEnterHint": "按 Enter 换行，不会发送",
    "chat.editorPreviewEmpty": "暂无内容可预览",
    ...
    "i18n.thinking": "正在思考",
    "i18n.thoughtFor": "思考了 {seconds} 秒",
    "chat.questionnaireSelectAll": "选择所有适用选项。",
    "chat.questionnaireRecommended": "推荐",
    "chat.questionnaireCustom": "自行输入答案",
    "chat.questionnaireCustomPlaceholder": "你的答案",
    "chat.questionnaireCustomHint": "Enter 保存 · Esc 返回",
    "chat.questionnaireCount": "{count} 个问题",
    "chat.questionnaireAnsweredSummary": "已回答问题 · {answered}/{total}",
    "chat.questionnaireAsking": "正在询问用户",
    "chat.questionnaireDismissed": "问卷已取消",
    "chat.questionnaireUnanswered": "未回答",
    "chat.questionnaireReview": "回顾",
    "chat.questionnaireReviewTitle": "确认答案",
    "chat.questionnaireNext": "下一步",
    ...
    "changes.vsUpstream": "对比上游",
    "changes.unified": "单栏",
    "changes.split": "分栏",
    "changes.diffLayout": "差异布局",
    "changes.tree": "树状",
    "changes.flat": "平铺",
    "changes.listLayout": "文件列表布局",
    "changes.resizeList": "调整文件列表宽度",
    "changes.dragResize": "拖动或方向键调整宽度 · 双击复位",
    "changes.oneFile": "1 个文件",
    "changes.fileCount": "{count} 个文件",
    "changes.refresh": "刷新",
    "changes.closeTab": "关闭标签页",
    "changes.branch": "分支",
    "changes.switchBranch": "切换分支",
    "changes.switchBranchHint": "切换分支；被其他工作树占用的分支会直接跳转过去",
    "changes.project": "项目",
    "changes.pickOtherProject": "选择其他目录…",
    "changes.inWorktree": "（工作树）",
    "changes.detached": "（分离头指针）",
    "changes.noDirectory": "尚未选择工作目录。",
    "changes.chooseDirectory": "选择目录…",
    "changes.chooseAnother": "换个目录…",
    "changes.notGit": "这不是 Git 仓库。",
    "changes.loading": "加载中…",
    "changes.noLocalChanges": "没有本地改动",
    "changes.noUpstreamDiff": "与上游没有差异",
    "changes.noUpstream": "未配置上游分支",
    "changes.selectFile": "请选择一个文件",
    "changes.loadingDiff": "差异加载中…",
    "changes.pickTitle": "选择仓库目录",
    "changes.pickParent": "上一级目录",
    "changes.pickSystem": "系统对话框…",
    "changes.pickNoSubdirs": "没有子目录",
    "changes.pickCancel": "取消",
    "changes.pickConfirm": "选择此目录",
    "changes.pickHome": "主目录",
  },
};
