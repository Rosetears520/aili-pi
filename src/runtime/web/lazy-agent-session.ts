...
export class LazyOfficialAgentSession<T extends OfficialAgentSessionLike = OfficialAgentSessionLike> {
  ...
  public async get(): Promise<T> {
    ...
    if (!this.options.compatible()) throw new Error("official Pi 0.84.4 compatibility is required before session mutation");
...
export const OFFICIAL_PI_VERSION = "0.84.4" as const;
