...
describe("Pi package baseline", () => {
  ...
  it("includes user documentation and generated provenance gates", async () => {
    ...
    expect(readme).toContain("npx -y rose-aili@0.4.13 install");
    expect(readme).toContain("npx -y rose-aili@0.4.13 update");
    ...
    expect(readme).toContain("skill verification snapshot");
    expect(readme).toContain("`rose-aili@0.4.13` commit `2fb0f64f165bba9f3d70acb60c8923c1efec0d93`");
