...
import { captureStampProvenance, isStampEntry, registerStampCommand, STAMP_ENTRY_TYPE } from "../../extensions/stamp/index.js";
...
describe("AILI Stamp retained timing and provenance", () => {
  ...
  it("records local lifecycle timing and tool outcome without call IDs or payloads", () => {
    ...
    expect(entries).toEqual([
      { type: STAMP_ENTRY_TYPE, data: { version: 2, kind: "assistant", timestamp: 100, completedAt: 160, firstContentAt: 125, provenance: { api: "responses", provider: "openai", requestedModel: "gpt-test" } } },
