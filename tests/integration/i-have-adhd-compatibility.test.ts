...
describe("i-have-adhd Pi compatibility", () => {
  ...
  it("binds the official local Pi 0.84.4 skill docs and native discovery API", async () => {
    ...
    expect(JSON.parse(packageText).version).toBe("0.84.4");
  ...
  it("uses Pi 0.84.4 native ~/.agents/skills discovery and progressive disclosure", async () => {
